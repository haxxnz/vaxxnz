...
import styles from "./HealthpointModal.module.scss";
...
const HealthpointModal: FunctionComponent<Props> = ({
    ...
    return (
        <div style={dialogStyle as any}>
            ...
            <section className={styles["walk-heading"]}>
                <h1>{location.name}</h1>
            ...
            <section
                className={`${styles["walk-grid"]} modal-container WalkModal`}
            >
                <div className={styles["walk-instructions"]}>
                    ...
                    <a
                        ...
                        onClick={() =>
                            enqueueAnalyticsEvent(
                                "Healthpoint Get Directions clicked",
                                {
                    ...
                    {location.opennningHours.notesHtml.map(
                        (noteHtml, index) => {
                            return (
