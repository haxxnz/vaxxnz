...
import styles from "./TodayLocationsSection.module.scss";
    ...
    return (
        <div>
            ...
            {"loading" in locations ? (
                <div className={styles["walk-message"]}>
                    <CustomSpinner />
                    <div
                        style={{
                            marginLeft: "1rem",
                ...
                <div className={styles["walk-message"]}>
                    Loading failed: {locations.error.message}
                </div>
            ) : locations.ok.length === 0 ? (
                <div className={styles["walk-message"]}>
                    {t("walkins.noWalkinDriveThruFound")}
                </div>
            ) : (
                <>
                    ...
                    {"ok" in locations &&
                        locations.ok.length / currentView > 1 && (
