const PrivacyPolicy = () => {
  return (
    <div style={{ margin: "3rem" }}>
      ...
      >
        This privacy policy sets out how vaxx.nz (“vaxx.nz”) collects, processes
        and uses your Personal Information through your use of our Services.
      </p>
      <br />
      <h3>Definitions</h3>
      <p>
        ...
        specifically appointed by us to deal with your enquiries with respect to
        this privacy policy and your Personal Information.
        <br />
        <br />
        <strong>Personal Information</strong> means any identifying information
        about you. This includes, but is not limited to, the following: cookies
        and usage data.
        <br />
        <br />
        <strong>Services</strong> means all services provided by vaxx.nz to you,
        including (but not limited to) this Website and the following: Delivery
      ...
      <p>
        <br />
        We only collect and use Personal Information to the extent necessary to
        provide you with the Services. We collect Personal Information for the
        Website to provide you with a better online experience.
        <br />
        ...
        <br />
        <br />
        To deliver the Services, fulfill and manage customer orders and provide
        customer support.
      </p>
      <br />
      ...
      <p>
        <br />
        We keep Personal Information for the shortest time necessary to provide
        you with Services and to meet all our legal and compliance obligations.
        To determine this retention period, we take into account
        <br />
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            Log and usage data: This includes usage and performance information
      ...
      <p>
        ...
        <ul>
          <li>
            <strong>Access: </strong>You may request from us access to your data
            that we hold on you.
          </li>
          <li>
            <strong>Rectification: </strong>If the data we hold on you is
            inaccurate, you may request that we correct it. If the data we hold
            is incomplete, you may request that we complete it.
          </li>
          <li>
          ...
          <li>
            ...
            may request that we restrict the processing of data we hold on you.
          </li>
          <li>
            <strong>Portability: </strong>Subject to certain conditions, you may
            request that we transfer all the data we hold on you to a third
            party (including yourself).
          </li>
          <li>
            <strong>Objections: </strong>Subject to certain conditions, you may
            object to us processing the data we hold on you.
          </li>
        </ul>
      </p>
      ...
      <p>
        ...
        media sites and platforms, for example Facebook, Instagram and Twitter.
        When you interact with our Services through these social media
        platforms, you may allow us to receive Personal Information and other
        Anonymized Data on how you are interacting with our Services. This will
        depend on your privacy settings on each social media site and platform.
        <br />
        The data we are provided by you through your interaction with our
        Services on social media sites and platforms will be used by us subject
        to the terms of this privacy policy. Depending on your social media
        site’s privacy settings, your Personal Information may become public to
        a community of users if you choose to engage with our Services through
        these platforms.
        <br />
      ...
      <p>
        ...
        (“Child”). If you become aware that a Child has provided us with
        Personal Information, please contact us. If we become aware that we have
        collected Personal Information from a Child without their parent's
        verifiable authorization to access our Services, we will take steps to
      ...
      <p>
        ...
        managed by vaxx.nz. This privacy policy applies to this website only. If
        you click a link to a third-party website, the privacy policy of that
        website will apply. We highly recommend that you read the privacy
      ...
      <p>
        <br />
        We are constantly reviewing our privacy policy and procedures to ensure
        that they meet best practices. This policy was last updated on September
        21, 2021.
        <br />
        <br />
      </p>
      ...
      <p>
        ...
        want to know more information about Personal Information we hold, please
        contact us at info@vaxx.nz.
        <br />
        <br />
      </p>
      <h3>Complaints</h3>
