  ...
  return (
    <>
      <Container>
        ...
        <p>
          <br />
          <strong>First-Party Cookies:</strong> First-party cookies are
          controlled by us.
          <br />
          <br />
          <strong>Third-Party Cookies</strong> Third-party cookies are
          controlled by our third-party advertisers. A list of our third-party
          advertiser affiliates is contained in our privacy policy.
          <br />
          <br />
        ...
        <p>
          ...
          the availability and functionality of the Sites. For more information
          on how to control cookies, check your browser or device’s settings for
          how you can control or reject cookies, or visit the following links:
          <br />
          <br />
